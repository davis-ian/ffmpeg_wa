<template>
  <div class="thumbnail-clipper">
    ...
    <div class="thumbnail-container" v-if="thumbnailSrc">
      <img :src="thumbnailSrc" alt="Generated thumbnail" />
    </div>

    <div class="button-container" v-if="thumbnailSrc">
      <button class="btn btn-secondary" @click="thumbnailSrc = null">
        <svg
          class="btn-icon"
          viewBox="0 0 24 24"
          fill="none"
    ...
    <div class="button-container" v-if="!thumbnailSrc">
      ...
      <button class="btn btn-danger" v-if="showProgress" @click="terminate">
        <svg
          class="btn-icon"
          viewBox="0 0 24 24"
          fill="none"
